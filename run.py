...
if __name__ == '__main__':
    ...
    # -s : 打印信息
    # -m ：运行含标签的用例
    # pytest.main(["-vs", f"{cur_path}\\TestCase\\plananalysiscase\\test_planal.py", "--alluredir", report_path])
    pytest.main(["-vs", f"{cur_path}\\TestCase\\weekplancase\\test_weekplan.py", "--alluredir", report_path])
    # pytest.main(
